...
export const pizzas: Products = [
  {
    id: 1,
    title: "Sicilian",
    desc: "Ignite your taste buds with a fiery combination of spicy pepperoni, jalapeños,  red pepper flakes, and melted mozzarella cheese, delivering a kick with every bite.",
    img: "/p1.png",
    price: 24.9,
    options: [
      {
  ...
  },
  {
    ...
    desc: "Delight in a culinary voyage with this vibrant Pesto Primavera dish, bursting with the flavors of freshly-made pesto, crisp seasonal vegetables, and a medley of aromatic herbs, all harmoniously combined to create a symphony of taste and texture.",
    img: "/p10.png",
    price: 28.9,
    options: [
      {
